...
3. Classify every important statement as Current, Target, Proposed, or Blocked.
4. Check root `BAGAS_BACKEND_HANDOFF.md`; never treat a proposed item as an implemented contract.
5. Identify Asprak, Praktikan, Superadmin, backend, database, Docker/Nginx, auth, dependency, and security scope.
6. Treat backend and Superadmin edits as out of scope unless Aidan explicitly authorizes them for the current task.
