    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          ...
          <h2 id="membership-heading" className="mt-1 text-xl font-bold tracking-tight text-slate-950">
            Enrolled as {user.username}
          </h2>
          <p className="mt-1 wrap-break-word text-xs text-slate-500">{user.email}</p>
        </div>
      </div>
      <div className="mt-6 flex items-start gap-3 rounded-2xl border border-slate-200/60 bg-slate-50 p-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs leading-5 text-slate-500">
            Only your own enrollment details are shown here. Class rosters and staff directories are not
